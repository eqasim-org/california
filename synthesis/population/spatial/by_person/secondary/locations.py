...
def configure(context):
    ...
    context.stage("synthesis.population.spatial.by_person.primary_locations_education")
...
def prepare_locations(context):
    ...
    df_home, df_work = context.stage("synthesis.population.spatial.by_person.primary_locations")
    df_education = context.stage("synthesis.population.spatial.by_person.primary_locations_education")
...
def prepare_destinations(context):
    df_destinations = context.stage("synthesis.destinations")[0]
