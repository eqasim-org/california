...
def execute(context):
    ...
    df_spatial = gpd.GeoDataFrame(df_activities, crs = dict(init = "epsg:2227"))
    ...
    df_spatial = gpd.GeoDataFrame(df_spatial, crs = dict(init = "epsg:2227"))
    df_spatial["destination_purpose"] = df_spatial["destination_purpose"].astype(str)
    df_spatial["origin_purpose"] = df_spatial["origin_purpose"].astype(str)
