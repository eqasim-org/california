...
def execute(context):
    df = pd.read_csv("%s/population/person_synthetic_merged_v2.csv" % context.config("data_path"))
    df_households = pd.read_csv("%s/population/household_synthetic_merged_v2.csv" % context.config("data_path"))
